...
function findNthSampleValue(min, rangeSpan, resolution, n) {
...
function sample(shapeEdges, holeEdges, shapeBoundary) {
...
function connectAmongSamples(samplesInShape, pointsBuffer, shapeBoundary) {
...
function pointsOnSameSide(point1, point2, edgeP1, edgeP2) {
    // flatten the the vectors and check their cross products, a negative z coordinate means clockwise rotation
    // edgeP1 and startClosest; edgeP1 and endClosest
...
function correctWindingOrders(geometry) {
